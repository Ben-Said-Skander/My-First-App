...
class HC5 extends StatefulWidget {
  @override
  State<HC5> createState() => _HP1State();
}

class _HP1State extends State<HC5> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/HighCarbs/hc5.jpg", width: double.infinity),tag: "hc5",),
        SizedBox(height: 15,),

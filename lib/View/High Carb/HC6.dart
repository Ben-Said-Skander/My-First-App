...
class HC6 extends StatefulWidget {
  @override
  State<HC6> createState() => _HP1State();
}

class _HP1State extends State<HC6> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/HighCarbs/hc6.jpg", width: double.infinity),tag: "hc6",),
        SizedBox(height: 15,),

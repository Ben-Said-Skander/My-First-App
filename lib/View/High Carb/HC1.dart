...
class HC1 extends StatefulWidget {
  @override
  State<HC1> createState() => _HP1State();
}

class _HP1State extends State<HC1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/HighCarbs/hc1.jpg", width: double.infinity),tag: "hc1",),
        SizedBox(height: 15,),

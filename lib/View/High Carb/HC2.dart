...
class HC2 extends StatefulWidget {
  @override
  State<HC2> createState() => _HP1State();
}

class _HP1State extends State<HC2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
       ...
       Hero(child:Image.asset("IMAGE/HighCarbs/hc2.jpg", width: double.infinity),tag: "hc2",),
        SizedBox(height: 15,),

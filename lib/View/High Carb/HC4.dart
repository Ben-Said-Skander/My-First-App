...
class HC4 extends StatefulWidget {
  @override
  State<HC4> createState() => _HP1State();
}

class _HP1State extends State<HC4> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/HighCarbs/hc4.jpg", width: double.infinity),tag: "hc4",),
        SizedBox(height: 15,),

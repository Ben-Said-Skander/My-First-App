...
class Egg6 extends StatefulWidget {
  @override
  State<Egg6> createState() => _Egg6State();
}

class _Egg6State extends State<Egg6> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
       ...
       Hero(child:Image.asset("IMAGE/Eggs/Eg6.jpg", width: double.infinity),tag: "Eg6",),
        SizedBox(height: 15,),

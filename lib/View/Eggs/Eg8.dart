...
class Egg8 extends StatefulWidget {
  @override
  State<Egg8> createState() => _Egg8State();
}

class _Egg8State extends State<Egg8> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
       ...
       Hero(child:Image.asset("IMAGE/Eggs/Eg8.jpg", width: double.infinity),tag: "Eg8",),
      Container( 

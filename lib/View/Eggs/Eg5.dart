...
class Egg5 extends StatefulWidget {
  @override
  State<Egg5> createState() => _Egg5State();
}

class _Egg5State extends State<Egg5> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/Eggs/Eg5.jpg", width: double.infinity),tag: "Eg5",),
        Container( 

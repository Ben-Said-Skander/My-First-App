...
class Egg4 extends StatefulWidget {
  @override
  State<Egg4> createState() => _Egg4State();
}

class _Egg4State extends State<Egg4> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/Eggs/Eg4.jpg", width: double.infinity),tag: "Eg4",),
        SizedBox(height: 15,),

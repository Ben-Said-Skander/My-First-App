...
class Egg7 extends StatefulWidget {
  @override
  State<Egg7> createState() => _Egg7State();
}

class _Egg7State extends State<Egg7> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
       ...
       Hero(child:Image.asset("IMAGE/Eggs/Eg7.jpg", width: double.infinity),tag: "Eg7",),
    Container( 
        ...
        Padding(
          ...
          child: Text("Skillet Lemon Chicken with Spinach",style:TextStyle(color: Colors.white, fontWeight: FontWeight .bold , fontSize: 18)),
        ),SizedBox(height:12),

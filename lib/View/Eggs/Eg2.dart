...
class Egg2 extends StatefulWidget {
  @override
  State<Egg2> createState() => _Egg2State();
}

class _Egg2State extends State<Egg2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
       ...
       Hero(child:Image.asset("IMAGE/Eggs/Eg2.jpg", width: double.infinity),tag: "Eg2",),
        SizedBox(height: 15,),

...
class Egg10 extends StatefulWidget {
  @override
  State<Egg10> createState() => _Egg10State();
}

class _Egg10State extends State<Egg10> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/Eggs/Eg10.jpg", width: double.infinity),tag: "Eg10",),
        Container( 
        ...
        Padding(
          ...
          child: Text("Skillet Lemon Chicken with Spinach",style:TextStyle(color: Colors.white, fontSize: 18)),
        ),SizedBox(height:12),

...
class _YogaState extends State<Yoga> {
  ...
  {"name":"Yoga Workout By fraser Wilson"},
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(leading:IconButton(onPressed:(){}, icon:Icon(Icons.exit_to_app)),backgroundColor: mainColor,title: Text("Yoga Workout",style:TextStyle(color: Colors.white , fontSize: 18),),),

...
class _BandsState extends State<Bands> {
  ...
  {"name":"Bands Workout By fraser Wilson"},
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(leading:IconButton(onPressed:(){}, icon:Icon(Icons.exit_to_app)),backgroundColor: mainColor,title: Text("Bands Workout",style:TextStyle(color: Colors.white , fontSize: 18),),),

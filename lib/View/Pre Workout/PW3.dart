...
class PW3 extends StatefulWidget {
  @override
  State<PW3> createState() => _PW3State();
}

class _PW3State extends State<PW3> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/PreWorkout/3.jpg", width: double.infinity),tag: "PW3",),
        SizedBox(height: 15,),

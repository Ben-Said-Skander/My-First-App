...
class PW7 extends StatefulWidget {
  @override
  State<PW7> createState() => _PW7State();
}

class _PW7State extends State<PW7> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/PreWorkout/8.jpg", width: double.infinity),tag: "PW7",),
        SizedBox(height: 15,),

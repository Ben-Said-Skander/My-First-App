...
class PW6 extends StatefulWidget {
  @override
  State<PW6> createState() => _PW6State();
}

class _PW6State extends State<PW6> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/PreWorkout/6.jpg", width: double.infinity),tag: "PW6",),
        SizedBox(height: 15,),

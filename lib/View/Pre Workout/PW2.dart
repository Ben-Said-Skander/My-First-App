...
class PW2 extends StatefulWidget {
  @override
  State<PW2> createState() => _PW2State();
}

class _PW2State extends State<PW2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/PreWorkout/22.jpg", width: double.infinity),tag: "PW2",),
        SizedBox(height: 15,),

...
class HP6 extends StatefulWidget {
  @override
  State<HP6> createState() => _HP6State();
}

class _HP6State extends State<HP6> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/High-Protein/hp6.jpg", width: double.infinity),tag: "HP6",),
        SizedBox(height: 15,),

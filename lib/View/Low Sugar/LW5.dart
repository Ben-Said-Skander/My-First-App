...
class LW5 extends StatefulWidget {
  @override
  State<LW5> createState() => _LW5State();
}

class _LW5State extends State<LW5> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/Low-Sugar/LW5.jpg", width: double.infinity),tag: "LW5",),
        SizedBox(height: 15,),

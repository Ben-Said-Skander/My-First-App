...
class LW4 extends StatefulWidget {
  @override
  State<LW4> createState() => _LW4State();
}

class _LW4State extends State<LW4> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/Low-Sugar/LW4.jpg", width: double.infinity),tag: "LW4",),
        SizedBox(height: 15,),

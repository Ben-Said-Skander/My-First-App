...
class LW9 extends StatefulWidget {
  @override
  State<LW9> createState() => _LW9State();
}

class _LW9State extends State<LW9> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/Low-Sugar/LW9.jpg", width: double.infinity),tag: "LW9",),
        SizedBox(height: 15,),

...
class LW1 extends StatefulWidget {
  @override
  State<LW1> createState() => _LW1State();
}

class _LW1State extends State<LW1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/Low-Sugar/LW1.jpg", width: double.infinity),tag: "LW1",),
        SizedBox(height: 15,),

...
class LW8 extends StatefulWidget {
  @override
  State<LW8> createState() => _LW8State();
}

class _LW8State extends State<LW8> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/Low-Sugar/LW8.jpg", width: double.infinity),tag: "LW8",),
        SizedBox(height: 15,),

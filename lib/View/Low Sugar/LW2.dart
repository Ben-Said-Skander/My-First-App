...
class LW2 extends StatefulWidget {
  @override
  State<LW2> createState() => _LW2State();
}

class _LW2State extends State<LW2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/Low-Sugar/LW2.jpg", width: double.infinity),tag: "LW2",),
        SizedBox(height: 15,),

...
class LW3 extends StatefulWidget {
  @override
  State<LW3> createState() => _LW3State();
}

class _LW3State extends State<LW3> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/Low-Sugar/LW3.jpg", width: double.infinity),tag: "LW3",),
        SizedBox(height: 15,),

...
class LW6 extends StatefulWidget {
  @override
  State<LW6> createState() => _LW6State();
}

class _LW6State extends State<LW6> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        Hero(child:Image.asset("IMAGE/Low-Sugar/LW6.jpg", width: double.infinity),tag: "LW6",),
        SizedBox(height: 15,),
